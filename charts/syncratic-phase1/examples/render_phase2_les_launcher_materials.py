...
def main() -> int:
    ...
    parser.add_argument(
        "--env-file",
        default="kubernetes/helm/syncratic-phase1/examples/phase2-les-launcher.materials.env",
    ...
    documents = [
        secret_doc(
            "syncratic-phase1-registration-les-mtls-ca",
            args.namespace,
            {
                "tls.crt": cert_pem,
                "tls.key": key_pem,
        ...
        secret_doc(
            "syncratic-phase1-registration-les-initial-license",
            args.namespace,
            {

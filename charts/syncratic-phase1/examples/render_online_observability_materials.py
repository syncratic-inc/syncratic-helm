...
def main() -> int:
    ...
    parser.add_argument(
        "--env-file",
        default="kubernetes/helm/syncratic-phase1/examples/online-observability.materials.env",
    ...
    documents = [
        ...
        secret_doc(
            "syncratic-phase1-keycloak-admin",
            args.namespace,
            {
        ...
        secret_doc(
            "syncratic-phase1-observability-grafana-admin",
            args.namespace,
            {
        ...
        configmap_doc(
            "syncratic-phase1-keycloak-realm",
            args.namespace,
            {

...
This chart is the phase-1 Kubernetes packaging skeleton described in:

- `docs/kubernetes/kubernetes_implementation_plan_phase1_v1.md`
...
It also now carries an explicit model-binding ownership contract for phase-1:

- `modelBindings.dbOnly=true` by default
- `modelBindings.bootstrapSync=false` by default

That means phase-1 treats runtime model endpoints as Admin-owned configuration, not environment fallback defaults.
...
It now also carries an explicit stateless scaling contract for the main phase-1 runtime slice:
...
- it does not yet absorb Prometheus, Loki, Tempo, or the full monitoring stack into the phase-1 chart
...
- the default phase1 chart remains renderable in a non-mTLS bootstrap posture
...
- chart-owned PostgreSQL init now creates the compatibility role `syncratic_app` so grant-oriented gateway migrations can run cleanly on a fresh phase-1 database
...
- `scripts/import_syncratic_phase1_k3s_images.sh`
- `scripts/run_syncratic_phase1_cluster_release.sh`
...
- `<release>-syncratic-phase1-material-contract`
...
The phase-1 runtime now also has a self-hosted delivery-gate workflow:

- [syncratic-phase1-helm-delivery.yml](/home/adminalien/docker/syncratic-core/.github/workflows/syncratic-phase1-helm-delivery.yml)

For real cluster mutation, the phase-1 runtime now also has a self-hosted cluster-release workflow:

- [syncratic-phase1-cluster-release.yml](/home/adminalien/docker/syncratic-core/.github/workflows/syncratic-phase1-cluster-release.yml)

Supporting tooling:

- [run_syncratic_phase1_helm_delivery_gate.sh](/home/adminalien/docker/syncratic-core/scripts/run_syncratic_phase1_helm_delivery_gate.sh)
- [run_syncratic_phase1_cluster_release.sh](/home/adminalien/docker/syncratic-core/scripts/run_syncratic_phase1_cluster_release.sh)
- [validate_syncratic_phase1_cluster_release_runner.sh](/home/adminalien/docker/syncratic-core/scripts/validate_syncratic_phase1_cluster_release_runner.sh)
- [export_syncratic_phase1_delivery_evidence.py](/home/adminalien/docker/syncratic-core/scripts/export_syncratic_phase1_delivery_evidence.py)
- [run_syncratic_phase1_release_checkpoint.sh](/home/adminalien/docker/syncratic-core/scripts/run_syncratic_phase1_release_checkpoint.sh)
- [build_syncratic_phase1_release_checkpoint.py](/home/adminalien/docker/syncratic-core/scripts/build_syncratic_phase1_release_checkpoint.py)
- [export_syncratic_phase1_recovery_package.py](/home/adminalien/docker/syncratic-core/scripts/export_syncratic_phase1_recovery_package.py)
- [run_syncratic_phase1_restore_drill.py](/home/adminalien/docker/syncratic-core/scripts/run_syncratic_phase1_restore_drill.py)
- [validate_syncratic_phase1_delivery_runner.sh](/home/adminalien/docker/syncratic-core/scripts/validate_syncratic_phase1_delivery_runner.sh)
- [syncratic_phase1_delivery_runner_contract_v1.md](/home/adminalien/docker/syncratic-core/docs/kubernetes/syncratic_phase1_delivery_runner_contract_v1.md)
- [syncratic_phase1_cluster_release_runner_contract_v1.md](/home/adminalien/docker/syncratic-core/docs/kubernetes/syncratic_phase1_cluster_release_runner_contract_v1.md)
...
The phase-1 delivery workflow now also supports retained runtime recovery evidence through:

- [run_syncratic_phase1_recovery_evidence_flow.sh](/home/adminalien/docker/syncratic-core/scripts/run_syncratic_phase1_recovery_evidence_flow.sh)
- [build_syncratic_phase1_recovery_retention_manifest.py](/home/adminalien/docker/syncratic-core/scripts/build_syncratic_phase1_recovery_retention_manifest.py)
...
- the default phase-1 install remains stable because evaluation is still opt-in
...
```bash
kubectl exec -n <namespace> deployment/<release>-syncratic-phase1-keycloak -- \
...
The chart also reconciles the live Keycloak realm/client public URL contract after install/upgrade so existing realms do not retain stale `syncratic.customer.example` redirect URIs. Docker/R&D deployments may still expose `auth.syncratic.customer.example` for internal testing, but that is not the production default.
...
auth:
  ...
  bootstrapSmtp:
    ...
    useStarttls: true
    useSsl: false
    fromEmail: noreply@syncratic.customer.example
    fromName: Syncratic Notifications
    syncKeycloak: true
    passwordSecret:
...
Phase 1 assumes the following remain external or pre-provisioned:
...
This is the chart-side proof that phase-1 is not hand-waving secret and trust-material separation.
...
By default, the phase-1 Helm test hooks inherit the packaged `gateway.image` contract.
